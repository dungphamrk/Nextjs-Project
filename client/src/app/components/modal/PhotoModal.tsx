    ...
    <div className="modal">
      ...
      <div className="flex flex-col gap-[20px] py-[20px] rounded-[10px] bg-[#262626] w-[400px] z-3">
        <i
          ...
          className="fa-solid fa-xmark z-3 text-[30px] cursor-pointer text-white top-[20px] right-[20px] absolute"
        ></i>
        ...
        <div className="flex flex-col items-center justify-center min-h-[300px] gap-[20px]">
          ...
          <div className="text-[20px] text-center cursor-pointer">
